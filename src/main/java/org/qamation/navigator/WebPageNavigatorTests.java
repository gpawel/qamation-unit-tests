...
*/
    ...
    public void openYahooPage() {
        ...
        page.isReady();
        navigator.processNavigationSequence(new String[]{"moon","{ENTER}"},page);
    ...
    public void processNavigationStringWikipedia() {
        ...
        navigator.processNavigationSequence(navigation,page);
    ...
    public void processNavigationStringAmazon() {
        ...
        page.isReady();
        WebPageNavigator navigator = new WebPageNavigator(driver);
        navigator.processNavigationSequence(new String[] {"<@!{xpath=//*[contains(text(),'Hello. Sign in')]}>"},page);
        ...
        navigator.processNavigationSequence(new String[] {"gpawel17@mail.com","1qazxsw2!"}, page);
        navigator.processNavigationSequence(new String[] {"<@!{xpath=//div[@class='nav-search-field ']}>"}, page);
        navigator.processNavigationSequence(new String[] {"hair {SPACE} brash"}, page );
